...
levels = ["O3", "DII O3 combined", "O0", "DII O0 combined"]
...
for benchmark in df["benchmark"].unique():
    ...
    o0_dii = sub[sub["optimization_level"] == "DII O0 combined"]["compilation_time_seconds"].mean()
    o3_base = sub[sub["optimization_level"] == "O3"]["compilation_time_seconds"].mean()
    o3_dii = sub[sub["optimization_level"] == "DII O3 combined"]["compilation_time_seconds"].mean()
