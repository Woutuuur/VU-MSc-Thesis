...
def main():
    ...
    tab = []
    for optimization_level in ["DII O0 combined", "IC + DII O0 combined", "DII O3 combined", "IC + DII O3 combined"]:
    ...
    for benchmark in df["benchmark"].unique():
        ...
        o3_ic_dii_size = subset[subset["optimization_level"] == "IC + DII O3 combined"].iloc[0]["binary_size"]
        print(f"{benchmark} CI + DII O3 size increase compared to DII O3: {(o3_ic_dii_size - o3_dii_size) / o3_dii_size * 100:.2f}%")
